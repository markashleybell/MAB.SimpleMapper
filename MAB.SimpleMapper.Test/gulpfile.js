...
var openCoverArgs = [
    ...
    '-targetargs:"/out:\\"' + path.join('reports/testresults.xml') + '\\" ' + path.join('MAB.SimpleMapper.Test/bin/Debug/MAB.SimpleMapper.Test.dll') + '"',
    '-excludebyattribute:*.ExcludeFromTestCoverageAttribute',
    '-filter:"+[*]* -[MAB.SimpleMapper.Test*]* -[MAB.SimpleMapper]MAB.SimpleMapper.ExcludeFromTestCoverageAttribute"',
    '-register:user',
